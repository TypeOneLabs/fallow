...
import "github.com/TypeOneLabs/fallow/pkg/cloud"
...
// one as both a --gcp-<scope> flag and a FALLOW_GCP_<SCOPE> environment
...
const (
	EnvProject = "FALLOW_GCP_PROJECT"
	EnvFolder  = "FALLOW_GCP_FOLDER"
	EnvOrg     = "FALLOW_GCP_ORGANIZATION"
)
