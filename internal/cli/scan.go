...
import (
	...
	"github.com/TypeOneLabs/fallow/internal/config"
	"github.com/TypeOneLabs/fallow/pkg/cloud"
	"github.com/TypeOneLabs/fallow/pkg/cloud/gcp"
	"github.com/TypeOneLabs/fallow/pkg/graph"
	"github.com/TypeOneLabs/fallow/pkg/metrics"
	"github.com/TypeOneLabs/fallow/pkg/output"
	"github.com/TypeOneLabs/fallow/pkg/pricing"
	"github.com/TypeOneLabs/fallow/pkg/rules"
)
...
func newScanCmd(g *globalFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Args:  cobra.NoArgs,
		Example: "  fallow scan --gcp-project my-gcp-project\n" +
			"  fallow scan --gcp-project p --rules detached_disk --format json\n" +
			"  fallow scan --cache-file snap.json   # offline replay (full fidelity)\n" +
			"  fallow scan --fixture cai-assets.json   # offline replay (topology only)",
...
//     through `fallow scan --cache-file` with full fidelity.
